...
CLEANED_RED_WINE_FILE = PROCESSED_DATA_DIR/"cleaned-winequality-red.csv"
CLEANED_WHITE_WINE_FILE = PROCESSED_DATA_DIR/"cleaned-winequality-white.csv"

#Dataset resource
ZIP_URL = "https://archive.ics.uci.edu/static/public/186/wine+quality.zip"

#Model
MODEL = MODEL_DIR/"trained_model"